...
GridViewer is a browser-based tool for displaying worked and confirmed Maidenhead grid squares from ADIF log files on an interactive map. A live instance is available from time to time at http://sm0hpl.tplinkdns.com:8000/
